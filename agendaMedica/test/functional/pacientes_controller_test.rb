...
class PacientesControllerTest < ActionController::TestCase
  ...
  test "should create paciente" do
    assert_difference('Paciente.count') do
      post :create, paciente: { endereco: @paciente.endereco, id: @paciente.id, idade: @paciente.idade, nome: @paciente.nome, rg: @paciente.rg }
    end
  ...
  test "should update paciente" do
    put :update, id: @paciente, paciente: { endereco: @paciente.endereco, id: @paciente.id, idade: @paciente.idade, nome: @paciente.nome, rg: @paciente.rg }
    assert_redirected_to paciente_path(assigns(:paciente))
  end
